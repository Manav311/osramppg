                            ...
                            as7058_status_events_t sensor_events, const void *p_cb_param)
{
    ...
    printk("as7058_callback called 101");
...
void as7058_thread(void)
{
    while (1) {
        // Wait forever for the interrupt to signal data is ready
        k_sem_take(&as7058_data_ready_sem, K_FOREVER);

        // This function is likely part of the chiplib/OSAL.
        // It's the function that should read the I2C data and then
        // trigger your as7058_callback. You may need to find its name
        // or implement this part of the OSAL.
        // For example:
...
// Define the thread
K_THREAD_DEFINE(as7058_tid, 1024, as7058_thread, NULL, NULL, NULL, 7, 0, 0);