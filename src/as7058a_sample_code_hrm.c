...
//     if (result != ERR_SUCCESS) {
//         printf("as7058a_hrm_b0_initialize returned error %d.\n", result);
//         goto ERROR;
//     }
...
//     if (result != ERR_SUCCESS) {
//         printf("as7058a_hrm_b0_set_signal_routing returned error %d.\n", result);
//         goto ERROR;
//     }
...
//     if (result != ERR_SUCCESS) {
//         printf("as7058a_hrm_b0_start_processing returned error %d.\n", result);
//         goto ERROR;
//     }
...
//                 if (result != ERR_SUCCESS) {
//                     printf("as7058a_hrm_b0_get_output returned error %d.\n", result);
//                     goto ERROR;
//                 }
...
//             } else {
//                 printf("as7058a_hrm_b0_execute returned error %d.\n", result);
//                 goto ERROR;
//             }
...
//     if (result != ERR_SUCCESS) {
//         printf("as7058a_hrm_b0_stop_processing returned error %d.\n", result);
//         goto ERROR;
//     }
...
//     if (result != ERR_SUCCESS) {
//         printf("as7058a_hrm_b0_shutdown returned error %d.\n", result);
//     }
