...
/* This sample code shows how to acquire live data using the AS7058 Chip Library and how to process this data using the
 * SpO2 library of the AS7058A Vital Signs Algorithms. The sample code is intended to be executed on an x86-64 Windows
 * computer that has an AS7058A EVK connected via USB. The sample code is linked against as7058_osal_core_fw.dll, which
 * implements an OSAL for the AS7058 Chip Library. */
